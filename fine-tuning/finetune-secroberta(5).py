...
# Paths
TOKENIZED_DATA_DIR = "/content/drive/MyDrive/tokenized-secroberta"
BASE_OUTPUT_DIR = "/content/drive/MyDrive/secroberta-model_output"
CHECKPOINT_DIR = "/content/drive/MyDrive/secroberta-checkpoints"
